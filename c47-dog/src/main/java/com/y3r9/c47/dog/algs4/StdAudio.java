...
public final class StdAudio {
    ...
    private static byte[] readByte(String filename) {
        ...
        try {
            ...
            // try to read from URL
                ...
                URL url = com.y3r9.c47.dog.algorithms.std.StdAudio.class.getResource(filename);
    ...
    private static double[] note(double hz, double duration, double amplitude) {
        int N = (int) (com.y3r9.c47.dog.algorithms.std.StdAudio.SAMPLE_RATE * duration);
        double[] a = new double[N + 1];
        for (int i = 0; i <= N; i++)
            a[i] = amplitude * Math.sin(2 * Math.PI * i * hz / com.y3r9.c47.dog.algorithms.std.StdAudio.SAMPLE_RATE);
        return a;
    }
    ...
    public static void main(String[] args) {
        ...
        // 440 Hz for 1 sec
        double freq = 440.0;
        for (int i = 0; i <= com.y3r9.c47.dog.algorithms.std.StdAudio.SAMPLE_RATE; i++) {
            com.y3r9.c47.dog.algorithms.std.StdAudio.play(0.5 * Math.sin(2 * Math.PI * freq * i / com.y3r9.c47.dog.algorithms.std.StdAudio.SAMPLE_RATE));
        }
        ...
        for (int i = 0; i < steps.length; i++) {
            ...
            com.y3r9.c47.dog.algorithms.std.StdAudio.play(note(hz, 1.0, 0.5));
        }


        // need to call this in non-interactive stuff so the program doesn't terminate
        // until all the sound leaves the speaker.
        com.y3r9.c47.dog.algorithms.std.StdAudio.close();
