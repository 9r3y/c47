...
import com.y3r9.c47.dog.algorithms.std.StdIn;
...
public final class In {
	...
	public static int[] readInts(String filename) {
        return new com.y3r9.c47.dog.algorithms.std.In(filename).readAllInts();
    }
	...
	public static double[] readDoubles(String filename) {
        return new com.y3r9.c47.dog.algorithms.std.In(filename).readAllDoubles();
    }
	...
	public static String[] readStrings(String filename) {
        return new com.y3r9.c47.dog.algorithms.std.In(filename).readAllStrings();
    }
	...
	public static int[] readInts() {
        return new com.y3r9.c47.dog.algorithms.std.In().readAllInts();
    }
	...
	public static double[] readDoubles() {
        return new com.y3r9.c47.dog.algorithms.std.In().readAllDoubles();
    }
	...
	public static String[] readStrings() {
        return new com.y3r9.c47.dog.algorithms.std.In().readAllStrings();
    }
    ...
    public static void main(String[] args) {
        com.y3r9.c47.dog.algorithms.std.In in;
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new com.y3r9.c47.dog.algorithms.std.In(urlName);
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new com.y3r9.c47.dog.algorithms.std.In("./InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new com.y3r9.c47.dog.algorithms.std.In("../stdlib/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        in = new com.y3r9.c47.dog.algorithms.std.In("/n/fs/introcs/www/java/stdlib/InTest.txt");
        try {
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new com.y3r9.c47.dog.algorithms.std.In("G:\\www\\introcs\\stdlib\\InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
