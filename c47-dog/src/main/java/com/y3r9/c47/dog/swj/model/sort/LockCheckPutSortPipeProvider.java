 ...
 * @since project 3.0
 */
public class LockCheckPutSortPipeProvider<V> extends NativeSortPipeProvider<V> implements
        CheckPutSortPipe<V> {
     ...
     * @param size the size
     */
    public LockCheckPutSortPipeProvider(final int size) {
        super(size);
    }
     ...
     */
    public LockCheckPutSortPipeProvider() {
