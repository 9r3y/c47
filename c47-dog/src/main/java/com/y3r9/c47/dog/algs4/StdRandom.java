...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 2) com.y3r9.c47.dog.algorithms.std.StdRandom.setSeed(Long.parseLong(args[1]));
        double[] t = {.5, .3, .1, .1};

        com.y3r9.c47.dog.algorithms.std.StdOut.println("seed = " + com.y3r9.c47.dog.algorithms.std.StdRandom.getSeed());
        for (int i = 0; i < N; i++) {
            com.y3r9.c47.dog.algorithms.std.StdOut.printf("%2d ", uniform(100));
            com.y3r9.c47.dog.algorithms.std.StdOut.printf("%8.5f ", uniform(10.0, 99.0));
            com.y3r9.c47.dog.algorithms.std.StdOut.printf("%5b ", bernoulli(.5));
            com.y3r9.c47.dog.algorithms.std.StdOut.printf("%7.5f ", gaussian(9.0, .2));
            com.y3r9.c47.dog.algorithms.std.StdOut.printf("%2d ", discrete(t));
            com.y3r9.c47.dog.algorithms.std.StdOut.println();
        }

        String[] a = "A B C D E F G".split(" ");
        for (String s : a)
            com.y3r9.c47.dog.algorithms.std.StdOut.print(s + " ");
        StdOut.println();
    }
