...
public final class StdOut {
    ...
    public static void main(String[] args) {
        ...
        // write to stdout
        com.y3r9.c47.dog.algorithms.std.StdOut.println("Test");
        com.y3r9.c47.dog.algorithms.std.StdOut.println(17);
        com.y3r9.c47.dog.algorithms.std.StdOut.println(true);
        com.y3r9.c47.dog.algorithms.std.StdOut.printf("%.6f\n", 1.0 / 7.0);
    }
