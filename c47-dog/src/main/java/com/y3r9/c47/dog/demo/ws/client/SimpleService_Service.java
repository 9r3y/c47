...
public class SimpleService_Service extends Service {
    ...
    static {
        URL url = SimpleService_Service.class.getResource("/com/resource/SimpleService.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(SimpleService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/com/resource/SimpleService.wsdl");
        }       
        WSDL_LOCATION = url;
    }
