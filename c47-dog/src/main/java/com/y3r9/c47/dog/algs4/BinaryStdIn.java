...
import com.y3r9.c47.dog.algorithms.std.BinaryStdOut;
...
public final class BinaryStdIn {
    ...
    public static void main(String[] args) {
        ...
        while (!com.y3r9.c47.dog.algorithms.std.BinaryStdIn.isEmpty()) {
            char c = com.y3r9.c47.dog.algorithms.std.BinaryStdIn.readChar();
            com.y3r9.c47.dog.algorithms.std.BinaryStdOut.write(c);
        }
        BinaryStdOut.flush();
    }
}
