...
import com.y3r9.c47.dog.algorithms.std.In;
...
public final class StdIn {
    ...
    public static void main(String[] args) {
        ...
        String s = com.y3r9.c47.dog.algorithms.std.StdIn.readString();
        System.out.println("Your string was: " + s);
        System.out.println();

        System.out.println("Type an int: ");
        int a = com.y3r9.c47.dog.algorithms.std.StdIn.readInt();
        System.out.println("Your int was: " + a);
        System.out.println();

        System.out.println("Type a boolean: ");
        boolean b = com.y3r9.c47.dog.algorithms.std.StdIn.readBoolean();
        System.out.println("Your boolean was: " + b);
        System.out.println();

        System.out.println("Type a double: ");
        double c = com.y3r9.c47.dog.algorithms.std.StdIn.readDouble();
