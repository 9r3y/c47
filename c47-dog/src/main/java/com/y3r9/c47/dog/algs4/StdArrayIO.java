package com.y3r9.c47.dog.algs4;
/*************************************************************************
...
import com.y3r9.c47.dog.algorithms.std.*;
import com.y3r9.c47.dog.algorithms.std.StdOut;
...
public class StdArrayIO {
    ...
    public static void print(double[] a) {
        int N = a.length;
        com.y3r9.c47.dog.algorithms.std.StdOut.println(N);
        for (int i = 0; i < N; i++) {
            com.y3r9.c47.dog.algorithms.std.StdOut.printf("%9.5f ", a[i]);
        }
        com.y3r9.c47.dog.algorithms.std.StdOut.println();
    }
    ...
    public static void print(double[][] a) {
        int M = a.length;
        int N = a[0].length;
        com.y3r9.c47.dog.algorithms.std.StdOut.println(M + " " + N);
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                com.y3r9.c47.dog.algorithms.std.StdOut.printf("%9.5f ", a[i][j]);
            }
            com.y3r9.c47.dog.algorithms.std.StdOut.println();
        }
    }
    ...
    public static void print(int[] a) {
        ...
        com.y3r9.c47.dog.algorithms.std.StdOut.println(N);
        for (int i = 0; i < N; i++) {
            com.y3r9.c47.dog.algorithms.std.StdOut.printf("%9d ", a[i]);
        }
        com.y3r9.c47.dog.algorithms.std.StdOut.println();
    }
    ...
    public static void print(int[][] a) {
        ...
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                com.y3r9.c47.dog.algorithms.std.StdOut.printf("%9d ", a[i][j]);
            }
            com.y3r9.c47.dog.algorithms.std.StdOut.println();
        }
    }
    ...
    public static void print(boolean[] a) {
        ...
        com.y3r9.c47.dog.algorithms.std.StdOut.println(N);
        for (int i = 0; i < N; i++) {
            if (a[i]) com.y3r9.c47.dog.algorithms.std.StdOut.print("1 ");
            else com.y3r9.c47.dog.algorithms.std.StdOut.print("0 ");
        }
        com.y3r9.c47.dog.algorithms.std.StdOut.println();
    }
    ...
    public static void print(boolean[][] a) {
        ...
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                if (a[i][j]) com.y3r9.c47.dog.algorithms.std.StdOut.print("1 ");
                else com.y3r9.c47.dog.algorithms.std.StdOut.print("0 ");
            }
            com.y3r9.c47.dog.algorithms.std.StdOut.println();
        }
    ...
    public static void main(String[] args) {
        ...
        double[] a = com.y3r9.c47.dog.algorithms.std.StdArrayIO.readDouble1D();
        com.y3r9.c47.dog.algorithms.std.StdArrayIO.print(a);
        com.y3r9.c47.dog.algorithms.std.StdOut.println();

        // read and print a matrix of doubles
        double[][] b = com.y3r9.c47.dog.algorithms.std.StdArrayIO.readDouble2D();
        com.y3r9.c47.dog.algorithms.std.StdArrayIO.print(b);
        com.y3r9.c47.dog.algorithms.std.StdOut.println();

        // read and print a matrix of doubles
        boolean[][] d = com.y3r9.c47.dog.algorithms.std.StdArrayIO.readBoolean2D();
        com.y3r9.c47.dog.algorithms.std.StdArrayIO.print(d);
        StdOut.println();
    }
