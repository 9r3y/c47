...
public class GUI extends JPanel {
    ...
    private GUI(Environment env) {
        ...
        stackTool.setPreferredSize(new Dimension(500, 100));

        monitorTool = new MonitorTool(env);
        monitorTool.setPreferredSize(new Dimension(500, 50));
        ...
        sourceTreeTool.setPreferredSize(new Dimension(200, 450));

        classTreeTool = new ClassTreeTool(env);
        classTreeTool.setPreferredSize(new Dimension(200, 450));

        threadTreeTool = new ThreadTreeTool(env);
        threadTreeTool.setPreferredSize(new Dimension(200, 450));
        ...
        cmdTool.setPreferredSize(new Dimension(700, 150));

        appTool = new ApplicationTool(env);
        appTool.setPreferredSize(new Dimension(700, 200));
