...
<div class="container">
    ...
    <form class="form-signin" action="${rc.getContextPath()}/login" method="post">
        ...
        <input type="text" id="iptUsername" name="username" class="form-control" placeholder="用户名" required="" autofocus="">
        <label for="iptPassword" class="sr-only">密码</label>
        <input type="password" id="iptPassword" name="password" class="form-control" placeholder="密码" required="">
        <div class="checkbox">
            <label>
